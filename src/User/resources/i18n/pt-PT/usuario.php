...
return [
    ...
    'Update user account' => 'Atualizar conta de utilizador',
    ...
    'According to the European General Data Protection Regulation (GDPR) we need your consent to work with your personal data.' => 'De acordo com o Regulamento Geral sobre a Proteção de Dados (RGPD) precisamos do seu consentimento para guardar os seus dados pessoais.',
    'An email with instructions to create a new password has been sent to {email} if it is associated with an {appName} account. Your existing password has not been changed.' => 'Um email com as instruções para criar uma nova password foi enviado para {email} se estiver associado a uma conta em {appName}. A sua password atual não foi alterada.',
    'Awesome, almost there. Now you need to click the confirmation link sent to your new email address.' => 'Fantástico, está quase. Agora precisa carregar no link de confirmação que foi enviado para o seu novo email.',
    'Awesome, almost there. Now you need to click the confirmation link sent to your old email address.' => 'Fantástico, está quase. Agora precisa carregar no link de confirmação que foi enviado para o seu antigo email.',
    'Children' => 'Filhos',
    'Class' => '',
    ...
    'Password' => 'Password',
    'Rule class name' => '',
    'Select rule...' => 'Selecione uma regra',
    'Submit' => 'Submeter',
    'Two factor authentication protects you in case of stolen credentials' => 'Autenticação de dois fatores protege-o no caso de roubarem as suas credenciais',
    'Unfortunately, you can not work with this site without giving us consent to process your data.' => 'Infelizmente não pode trabalhar com este site se não der o seu consentimento para processar os seus dados.',
    'VKontakte' => '',
    'Website' => '',
    'Yandex' => '',
    'Your consent is required to work with this site' => 'É necessário dar o seu consentimento para trabalhar com este site',
